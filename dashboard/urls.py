...
urlpatterns = [
    ...
    path('add_plants_to_sale/<int:id>/', views.add_plants_to_sale,name= 'add_plants_to_sale'),
    path('delete_sale_product/<int:p_id>/<int:s_id>/', views.delete_sale_product,name= 'delete_sale_product'),
]
